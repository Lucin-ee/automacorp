...
class SensorControllerTest {
    ...
    void shouldFindAll() throws Exception {
        Mockito.when(sensorDao.findAll()).thenReturn(List.of(
                FakeEntityBuilder.createSensorEntity(1L, "Temperature room 1", SensorType.TEMPERATURE, 22.5),
    ...
    void shouldFindById() throws Exception {
        SensorEntity sensorEntity = FakeEntityBuilder.createSensorEntity(1L, "Temperature room 1", SensorType.TEMPERATURE, 22.5);
    ...
    void shouldUpdate() throws Exception {
        ...
        mockMvc.perform(
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.type").value(SensorType.TEMPERATURE))
                .andExpect(MockMvcResultMatchers.jsonPath("$.value").value(22.5));
    }
